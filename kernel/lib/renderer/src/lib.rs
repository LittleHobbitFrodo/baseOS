...
//  this crate lets you build your own renderer to be use by the `ministd` crate instead of the default one
...
pub trait MinistdRenderer: Send + core::fmt::Write {
    ...
    fn init(&mut self, fb: &crate::limine::request::FramebufferRequest) -> Result<(), ()>;
